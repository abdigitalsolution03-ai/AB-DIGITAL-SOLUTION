...
const defaultContent: SiteContent = {
  ...
  aboutPage: {
    ...
    team: [
      { name: 'Avnish Yadav', role: 'Founder', bio: 'Visionary founder driving strategy and brand growth.' },
      { name: 'Boby Singh', role: 'Co-Founder', bio: 'Co-founder managing operations and client success.' },
      { name: 'Rajnish Yadav', role: 'Content Writer', bio: 'Crafts engaging copy, captions and scripts that convert.' },
      { name: 'Ansh', role: 'Business Ads', bio: 'Plans and shoots business ads that drive leads and sales.' },
      { name: 'Ansh', role: 'Social Media Manager', bio: 'Manages social growth, content calendars and campaigns.' },
      { name: 'Abhay Sharma', role: 'Video Editor', bio: 'Edits reels and long-form videos focused on retention.' },
      { name: 'Subham', role: 'Performance Marketer', bio: 'Runs Meta and Google Ads for maximum ROI.' },
      { name: 'Deepanshu Singh Adhikari', role: 'Website Developer', bio: 'Builds fast, modern websites that convert visitors.' },
      { name: 'Pooja', role: 'Graphic Designer', bio: 'Designs thumbnails, creatives and premium brand visuals.' },
    ],
    timeline: [
