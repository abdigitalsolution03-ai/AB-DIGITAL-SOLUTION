...
const PORTFOLIO_SEED: Array<Record<string, any>> = [
  { title: 'White Bricks Real Estate', category: 'Social Media', description: 'Instagram management, post design & content calendar for a premium real estate brand.', image: '/portfolio-covers/white-brick-cover.png', instagramUrl: 'https://www.instagram.com/whitebrickrealestate', results: 'Instagram Management\nPost Design\nContent Calendar' },
  ...
  { title: 'Lawfine Care', category: 'Ads', description: 'Instagram posts, paid ads & video editing for a legal services brand.', image: '/portfolio-covers/lawfine-care-cover.png', instagramUrl: 'https://www.instagram.com/lawyerpanelexpert', results: 'Instagram Marketing\nMeta Ads\nVideo Editing' },
  ...
  { title: 'Ambrosial Catering', category: 'Social Media', description: 'Full-stack social media — Instagram & Facebook management, Meta ads, Pinterest & video editing.', image: '/portfolio-covers/ambrosial-cover.png', instagramUrl: 'https://www.instagram.com/ambrosial.catering', results: 'Instagram & Facebook\nMeta Ads\nPinterest\nVideo Editing' },
  { title: 'ATV News Bihar', category: 'Design', description: 'Logo and banner design for the ATV Bihar news channel.', image: '/portfolio-covers/atv-bihar-cover.png', videoUrl: 'https://www.youtube.com/@AtvBihar', videoThumb: 'https://i.ytimg.com/vi/50oa9NjCKxg/hqdefault.jpg', channelAvatar: 'https://yt3.googleusercontent.com/LHmvmQ-K6O9t3ZgTrl0-V2rTRWnA1MnW4YrRSzUD8kIn6bt8SXi94IsZWf8VaK4oCUVNumt1THo=s200-c-k-c0x00ffffff-no-rj', results: 'Logo Design\nBanner Design\nChannel Branding' },
  ...
  { title: 'Suraj Paul', category: 'Social Media', description: 'Instagram, LinkedIn & Facebook management, paid ads, Google My Business and video editing.', image: '/portfolio-covers/gmd-thrivex-cover.png', instagramUrl: 'https://www.instagram.com/surajpaulprosperity', results: 'Instagram / LinkedIn / Facebook\nPaid Ads\nGoogle My Business\nVideo Editing' },
  ...
  { title: 'Vidya Vibe Academy', category: 'Social Media', description: 'Instagram management — posts & editing for VVA Vasundhara.', image: '/portfolio-covers/vidya-vibe-cover.png', instagramUrl: 'https://www.instagram.com/vva_vasundhara', results: 'Instagram Management\nPosts\nEditing' },
  { title: 'Earthwell Infrabuild', category: 'Social Media', description: 'Social media management and brand content for Earthwell Infrabuild Private Limited.', image: '/portfolio-covers/earthwell-infrabuild-cover.png', results: 'Social Media\nBrand Content\nPost Design' },
  { title: 'Prediction', category: 'Design', description: 'Thumbnail and content design for Prediction, an astrology content brand.', image: '/portfolio-covers/prediction-cover.png', results: 'Thumbnail Design\nContent Design' },
]
