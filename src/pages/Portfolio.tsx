...
const hardcodedProjects: Project[] = [
  { title: "White Bricks Real Estate", category: "Social Media", description: "Instagram management, post design & content calendar for a premium real estate brand.", color: "#FF4D4D", image: "/portfolio-covers/white-brick-cover.png", instagramUrl: "https://www.instagram.com/whitebrickrealestate", metrics: ["Instagram Management", "Post Design", "Content Calendar"] },
  ...
  { title: "Lawfine Care", category: "Ads", description: "Instagram posts, paid ads & video editing for a legal services brand.", color: "#FF4D4D", image: "/portfolio-covers/lawfine-care-cover.png", instagramUrl: "https://www.instagram.com/lawyerpanelexpert", metrics: ["Instagram Marketing", "Meta Ads", "Video Editing"] },
  ...
  { title: "Suraj Paul", category: "Social Media", description: "Instagram, LinkedIn & Facebook management, paid ads, Google My Business and video editing.", color: "#8B5CF6", image: "/portfolio-covers/gmd-thrivex-cover.png", instagramUrl: "https://www.instagram.com/surajpaulprosperity", metrics: ["Instagram / LinkedIn / Facebook", "Paid Ads", "Google My Business", "Video Editing"] },
  ...
  { title: "Vidya Vibe Academy", category: "Social Media", description: "Instagram management — posts & editing for VVA Vasundhara.", color: "#FF4D4D", image: "/portfolio-covers/vidya-vibe-cover.png", instagramUrl: "https://www.instagram.com/vva_vasundhara", metrics: ["Instagram Management", "Posts", "Editing"] },
  { title: "Earthwell Infrabuild", category: "Social Media", description: "Social media management and brand content for Earthwell Infrabuild Private Limited.", color: "#4D7AFF", image: "/portfolio-covers/earthwell-infrabuild-cover.png", metrics: ["Social Media", "Brand Content", "Post Design"] },
