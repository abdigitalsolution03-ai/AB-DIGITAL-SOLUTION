          ...
          <table className="w-full">
            ...
            <tbody>
              {faqs.length === 0 ? (
                ...
                faqs.map((faq, index) => (
                  <tr key={faq.id} className="border-b border-[#111]/10 hover:bg-[#FFD400]/10 transition-colors">
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center justify-center w-7 h-7 bg-[#FFD400] border-2 border-[#111] text-[#111] text-xs font-bold">{index + 1}</span>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => moveDown(index)} disabled={index === faqs.length - 1} className="p-1.5 border-2 border-[#111] text-[#111]/40 hover:bg-[#FFD400] transition-all disabled:opacity-30 disabled:cursor-not-allowed">
                          <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <button onClick={() => openEdit(faq)} className="p-2 border-2 border-[#111] text-[#111]/40 hover:bg-[#FFD400] transition-all">
