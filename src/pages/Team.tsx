...
const hardcodedTeam = [
  ...
  { name: 'Bobby Singh', role: 'Founder', bio: 'Founder managing operations and making sure every client project succeeds.', color: '#FF4D4D', image: '/team/page_2.png' },
  ...
  { name: 'Shubham', role: 'Software Engineer', bio: 'Builds scalable web applications and robust backend systems with clean code.', color: '#10B981', image: '/team/subham.png' },
