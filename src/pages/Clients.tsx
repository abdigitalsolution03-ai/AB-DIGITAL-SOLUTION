...
const testimonials = [
    ...
    rating: 5},
  {
    ...
    content: "Working with AB DIGITAL SOLUTION has been a game-changer. Their branding work gave us a completely new identity that resonates perfectly with our customers.",
    rating: 5},
  {
    name: "Neha Gupta",
  ...
  {
    name: "Sunil Kumar",
    role: "Proprietor, Kumar Furniture",
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <AnimatedSection className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#111] mt-4 tracking-tight">
              Trusted by <span className="text-[#60A5FA]">Industry Leaders</span>
            </h1>
