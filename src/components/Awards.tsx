      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#111111] mt-4 tracking-tight" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
            Our <span className="text-[#FFD400]">Awards</span>
          </h2>
            ...
            <AnimatedSection key={i} delay={i * 0.08}>
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  <svg className="w-5 h-5 text-[#FFD400]" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  <span className="text-sm font-bold text-[#111111] bg-[#FFD400] px-3 py-1 border-2 border-[#111111]" style={{ borderRadius: "8px", fontFamily: "'Space Grotesk', sans-serif" }}>
                    {award.year}
                  </span>
                </div>

                <h3 className="text-lg font-bold text-[#111111] mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>{award.title}</h3>
                <p className="text-[#FFD400] font-semibold text-sm mb-0" style={{ fontFamily: "'Inter', sans-serif" }}>{award.organization}</p>
              </motion.div>
            </AnimatedSection>
          ))}
        </div>
